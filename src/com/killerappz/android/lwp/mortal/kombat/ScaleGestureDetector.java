package com.killerappz.android.lwp.mortal.kombat;
...
public class ScaleGestureDetector {
     ...
     * {@code true}.
     */
    public class SimpleOnScaleGestureListener implements 
        ...
        if (!mGestureInProgress) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mCurrPressure / mPrevPressure > PRESSURE_THRESHOLD) {
                    final boolean updatePrevious = mListener
                            .onScale(this );
    ...
    public float getTopFingerX() {
        return (mTopFingerIsPointer1) ? mTopFingerCurrX
                : mBottomFingerCurrX;
    }

    public float getTopFingerY() {
        return (mTopFingerIsPointer1) ? mTopFingerCurrY
                : mBottomFingerCurrY;
    }

    public float getTopFingerDeltaX() {
        return (mTopFingerIsPointer1) ? mTopFingerCurrX
                - mTopFingerBeginX : mBottomFingerCurrX
                - mBottomFingerBeginX;
    }

    public float getTopFingerDeltaY() {
        return (mTopFingerIsPointer1) ? mTopFingerCurrY
                - mTopFingerBeginY : mBottomFingerCurrY
                - mBottomFingerBeginY;
    }
